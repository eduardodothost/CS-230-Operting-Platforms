...
//Paths and roles correspond to attributes mapped in GameAuthenticator
// FIXME:DONE Add path annotation for gameusers 
@Path("/gameusers")
...
public class GameUserRESTController {
 ...
 //TODO:Maybe user Brackets here {"ADMIN"} instead of just ""
    // FIXME:DONE Add RolesAllowed annotation for USER based on BasicAuth Security Example 
    @GET
    @Path("/{id}")
    @RolesAllowed({"USER"})
    ...
    // FIXME:DONE Add RolesAllowed annotation for ADMIN based on BasicAuth Security Example 
